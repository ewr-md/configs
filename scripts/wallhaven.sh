#!/bin/bash
#
# This script gets the beautiful wallpapers from http://wall $haven.cc
...
APIKEY="cE3ZZC7W0CbJsU8OSFLZQd8ZmkQilmR0"
#####################################
...
LOCATION=/home/eric/Desktop/wallpapers/
